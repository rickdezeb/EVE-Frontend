                  ...
                  files.map((file, index) => (
                    <tr key={file.id}>
                      ...
                      {renameFileId === file.id ? (
                        ...
                        <td onClick={() => loadProductPage(file)} style={{ cursor: 'pointer' }} className="text-primary">
                          {file.name}
                        </td>
                      )}
                        ...
                        {dropdownOpen === index && (
                          <div className="dropdown" ref={dropdownRef}>
                            <div className="dropdown-menu show">
                              <button className="dropdown-item" onClick={() => setRenameFileId(file.id)} disabled={isLoadingRename}>
                                Rename
                              </button>
                            </div>
                          </div>
